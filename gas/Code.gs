...
var COLUMNS = [
  ...
  { key: 'q3_feeling',      label: 'Q3 購入後の連絡への評価' },
  { key: 'q4_dissat',       label: 'Q4 購入後の不満(複数)' },
  { key: 'q4_dissat_free',  label: 'Q4 その他(自由記述)' },
  { key: 'q5_intent',       label: 'Q5 買い増し意向' },
  { key: 'q6_research',     label: 'Q6 情報収集の頻度' },
  { key: 'q7_media',        label: 'Q7 重宝しているもの(複数)' },
  { key: 'q7_media_free',   label: 'Q7 その他(自由記述)' },
  { key: 'q8_edge',         label: 'Q8 重宝している理由(複数)' },
  { key: 'q8_edge_free',    label: 'Q8 その他(自由記述)' },
  { key: 'q9_income',       label: 'Q9 年収の連携粒度' },
  { key: 'q10_loan',        label: 'Q10 借入残高の連携粒度' },
  { key: 'q11_interview',   label: '取材協力' },
  { key: 'research_skipped', label: 'Q6-Q8スキップ' },
