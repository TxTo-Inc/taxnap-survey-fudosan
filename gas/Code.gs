...
var COLUMNS = [
  ...
  { key: 'q6_media',        label: 'Q6 重宝しているもの(複数)' },
  { key: 'q6_media_free',   label: 'Q6 その他(自由記述)' },
  { key: 'q7_edge',         label: 'Q7 重宝している理由(複数)' },
  { key: 'q7_edge_free',    label: 'Q7 その他(自由記述)' },
  { key: 'q8_income',       label: 'Q8 年収の連携粒度' },
  { key: 'q9_loan',         label: 'Q9 借入残高の連携粒度' },
  { key: 'q10_interview',   label: '取材協力' },
  { key: 'research_skipped', label: 'Q5-Q7スキップ' },
